-- local Whitelist = {"yPolar_x4", "yPolar_x6", "yPolar_x3", "yPolar_x9", "JOAZIN1236"}
...
--       Welcome = function()
--             return tostring(
--               " "..Gamename.. "" .. " \n Solar Hub"  .."\n Whitelisting: "..game.Players.LocalPlayer.DisplayName)
--       end
--    }
-- }
...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Solar Hub BF') then
        makefolder('Solar Hub BF')
    end
    if not _G.Dis and not isfile('Solar Hub BF/'..Name..'.json') then
        writefile('Solar Hub BF/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Solar Hub BF') and isfile('Solar Hub BF/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Solar Hub BF/'..Name..'.json'))
...
function CheckQuestBoss()
	-- Old World
		...
		elseif _G.SelectBoss == "Cake Queen [Lv. 2175] [Boss]" then
			...
			TelePBoss(CFrameBoss)
		elseif _G.SelectBoss == "Cake Prince [Lv. 2300] [Raid Boss]" then
			MsBoss = "Cake Prince [Lv. 2300] [Raid Boss]"
			NameBoss = "Cake Prince"
			CFrameBoss = CFrame.new(-2009.2802734375, 4532.97216796875, -14937.3076171875)
			TelePBoss(CFrameBoss)
		end
	end
		...
		function CheckLevel()
			...
			if Three_World then
				...
				elseif Lv == 1600 or Lv <= 1624 or SelectMonster == "Dragon Crew Archer [Lv. 1600]" then -- Dragon Crew Archer
					...
					if Auto_Farm and (CFrameMon.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 20000 then
						TP2(CFrame.new(6488.9155273438, 383.38375854492, -110.66246032715))
					end
				...
				elseif Lv >= 2200 and Lv <= 2224 or SelectMonster == "Cookie Crafter [Lv. 2200]" then -- Cookie Crafter
				...
				elseif Lv >= 2250 and Lv <= 2300 or SelectMonster == "Baking Staff [Lv. 2250]" then  -- Baking Staff
				...
				elseif Lv >= 2275 and Lv <= 2299 or SelectMonster == "Head Baker [Lv. 2275]" then -- Head Baker
				...
				elseif Lv >= 2300 and Lv <= 2324 or SelectMonster == "Cocoa Warrior [Lv. 2300]" then -- Head Baker
					Ms = "Cocoa Warrior [Lv. 2300]"
					NameQuest = "ChocQuest1"
					QuestLv = 1
					NameMon = "Cocoa Warrior"
					CFrameQ = CFrame.new(231.13571166992188, 24.734268188476562, -12195.1162109375)
					CFrameMon = CFrame.new(-143.4223175048828, 59.257164001464844, -12334.255859375)
					TP2(CFrame.new(231.13571166992188, 24.734268188476562, -12195.1162109375))
				elseif Lv >= 2325 and Lv <= 2349 or SelectMonster == "Chocolate Bar Battler [Lv. 2325]" then -- Chocolate Bar Battler
					...
					CFrameQ = CFrame.new(231.13571166992188, 24.734268188476562, -12195.1162109375)
					CFrameMon = CFrame.new(579.709716796875, 54.35321044921875, -12464.9599609375)
				elseif Lv >= 2350 and Lv <= 2374 or SelectMonster == "Sweet Thief [Lv. 2350]" then -- Sweet Thief
					...
					CFrameMon = CFrame.new(-20.140260696411133, 48.09735107421875, -12696.380859375)
				elseif Lv >= 2375 or Lv <= 2400 or SelectMonster == "Candy Rebel [Lv. 2375]" then -- Candy Rebel
					...
					NameMon = "Candy Rebel"
					CFrameQ = CFrame.new(147.52256774902344, 24.793832778930664, -12775.3583984375)
					CFrameMon = CFrame.new(139.2722930908203, 53.66075897216797, -12879.359375)
				end
			end
		end
		...
		function CheckLevel2()
			...
			if Old_World and not Auto_Raid then
				...
				elseif Lv == 400 or Lv <= 449 or SelectMonster == "Fishman Commando [Lv. 400]" then -- Fishman Commando
					...
					CFrameMon = CFrame.new(61868.59765625, 75.47233581542969, 1399.3028564453125)
					if Auto_Farm and (CFrameMon.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3000 then
						game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
						TP(CFrameQ)
				...
				elseif Lv == 550 or Lv <= 624 or SelectMonster == "Royal Soldier [Lv. 550]" then -- Royal Soldier
					...
					SelectMonster = "Royal Soldier [Lv. 550]"
				elseif Lv == 625 or Lv <= 649 or SelectMonster == "Galley Pirate [Lv. 625]" then -- Galley Pirate
				...
				elseif Lv >= 650 or SelectMonster == "Galley Captain [Lv. 650]" then -- Galley Captain
					...
					SelectMonster = "Galley Captain [Lv. 650]"
				end
			end
			...
			if Three_World and not Auto_Raid then
				...
				elseif Lv >= 1975 and Lv <= 1999 or SelectMonster == "Reborn Skeleton [Lv. 1975]" then -- Reborn Skeleton [Lv. 1975]
					...
					TelePBoss(CFrameQ)
				elseif Lv >= 2000 and Lv <= 2024 or SelectMonster == "Living Zombie [Lv. 2000]" then -- Living Zombie [Lv. 2000]
					Ms = "Living Zombie [Lv. 2000]"
					NameQuest = "HauntedQuest1"
					QuestLv = 2
					NameMon = "Living Zombie"
				...
				elseif Lv >= 2025 and Lv <= 2049  or  SelectMonster == "Demonic Soul [Lv. 2025]" then -- Demonic Soul [Lv. 2025]
					Ms = "Demonic Soul [Lv. 2025]"
					NameQuest = "HauntedQuest2"
					QuestLv = 1
					NameMon = "Demonic"
				...
				elseif Lv >= 2050 and Lv <= 2074 or SelectMonster == "Posessed Mummy [Lv. 2050]" then -- Posessed Mummy [Lv. 2050]
					Ms = "Posessed Mummy [Lv. 2050]"
					NameQuest = "HauntedQuest2"
					QuestLv = 2
				...
				elseif Lv >= 2075 and Lv <= 2099 or SelectMonster == "Peanut Scout [Lv. 2075]" then -- Peanut Scout [Lv. 2075]
					Ms = "Peanut Scout [Lv. 2075]"
					...
					TelePBoss(CFrameQ)
				elseif Lv >= 2100 and Lv <= 2124 or SelectMonster == "Peanut President [Lv. 2100]" then -- Peanut President [Lv. 2100]
					Ms = "Peanut President [Lv. 2100]"
					NameQuest = "NutsIslandQuest"
					QuestLv = 2
					...
					TelePBoss(CFrameQ)
				elseif Lv >= 2125 and Lv <= 2149 or SelectMonster == "Ice Cream Chef [Lv. 2125]" then -- Ice Cream Chef [Lv. 2125]
					Ms = "Ice Cream Chef [Lv. 2125]"
					NameQuest = "IceCreamIslandQuest"
					QuestLv = 1
					...
					TelePBoss(CFrameQ)
				elseif Lv >= 2150 and Lv <= 2199 or SelectMonster == "Ice Cream Commander [Lv. 2150]" then  -- Ice Cream Commander [Lv. 2150]
					Ms = "Ice Cream Commander [Lv. 2150]"
					NameQuest = "IceCreamIslandQuest"
					QuestLv = 2
					...
					TelePBoss(CFrameQ)
				elseif Lv >= 2200 and Lv <= 2224 or SelectMonster == "Cookie Crafter [Lv. 2200]" then  -- Cookie Crafter [Lv. 2200]
					Ms = "Cookie Crafter [Lv. 2200]"
					NameQuest = "CakeQuest1"
					QuestLv = 1
					...
					TelePBoss(CFrameQ)
				elseif Lv >= 2225 and Lv <= 2249 or SelectMonster == "Cake Guard [Lv. 2225]" then  -- Cake Guard [Lv. 2225]
					Ms = "Cake Guard [Lv. 2225]"
					NameQuest = "CakeQuest1"
					QuestLv = 2
					NameMon = "Cake Guard"
					...
					TelePBoss(CFrameQ)
				elseif Lv >= 2250 and Lv <= 2274 or SelectMonster == "Baking Staff [Lv. 2250]" then  -- Baking Staff [Lv. 2250]
					Ms = "Baking Staff [Lv. 2250]"
					NameQuest = "CakeQuest2"
					QuestLv = 1
					NameMon = "Baking Staff"
					...
					CFrameMon = CFrame.new(-1818.347900390625, 93.41275787353516, -12887.66015625)
					TelePBoss(CFrameQ)
			    elseif Lv >= 2275 and Lv <= 2299 or SelectMonster == "Head Baker [Lv. 2275]" then -- Head Baker [Lv. 2275]
					Ms = "Head Baker [Lv. 2275]"
					NameQuest = "CakeQuest2"
					QuestLv = 2
					NameMon = "Head Baker"
					...
					CFrameMon = CFrame.new(-2203.302490234375, 109.90937042236328, -12788.7333984375)
					TelePBoss(CFrameQ)
				elseif Lv >= 2300 and Lv <= 2324 or SelectMonster == "Cocoa Warrior [Lv. 2300]" then -- Cocoa Warrior [Lv. 2300]
					Ms = "Cocoa Warrior [Lv. 2300]"
					NameQuest = "ChocQuest1"
					QuestLv = 1
					NameMon = "Cocoa Warrior"
					...
					TP2(CFrame.new(231.13571166992188, 24.734268188476562, -12195.1162109375))
					TelePBoss(CFrameQ)
				elseif Lv >= 2325 and Lv <= 2349 or SelectMonster == "Chocolate Bar Battler [Lv. 2325]" then -- Chocolate Bar Battler [Lv. 2325]
					Ms = "Chocolate Bar Battler [Lv. 2325]"
					NameQuest = "ChocQuest1"
					QuestLv = 2
					NameMon = "Chocolate Bar Battler"
					...
					CFrameMon = CFrame.new(579.709716796875, 54.35321044921875, -12464.9599609375)
					TelePBoss(CFrameQ)
				elseif Lv >= 2350 and Lv <= 2374 or SelectMonster == "Sweet Thief [Lv. 2350]" then -- Sweet Thief [Lv. 2350]
					Ms = "Sweet Thief [Lv. 2350]"
					NameQuest = "ChocQuest2"
					QuestLv = 1
					NameMon = "Sweet Thief"
					...
					CFrameMon = CFrame.new(-20.140260696411133, 48.09735107421875, -12696.380859375)
					TelePBoss(CFrameQ)
				elseif Lv >= 2375 or SelectMonster == "Candy Rebel [Lv. 2375]" then -- Candy Rebel [Lv. 2375]
					Ms = "Candy Rebel [Lv. 2375]"
					NameQuest = "ChocQuest2"
					QuestLv = 2
					NameMon = "Candy Rebel"
...
if IKAI then
	...
	local uix =  game:GetService("CoreGui"):FindFirstChild("RippleOpenClose")  if uix then uix:Destroy() end
	...
	local RippleOpenClose = Instance.new("ScreenGui")
	...
	-- local ImageOpenClose = Instance.new("ImageLabel")
	local Strokefps = Instance.new("UIStroke")
	local Stroketime = Instance.new("UIStroke")
	local StrokeOpenClose = Instance.new("UIStroke")
	...
	RippleOpenClose.Name = "RippleOpenClose"
	RippleOpenClose.Parent = game.CoreGui
	RippleOpenClose.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	-- ImageOpenClose.Name = "ImageOpenClose"
	-- ImageOpenClose.Parent = RippleOpenClose
	-- ImageOpenClose.BackgroundColor3 = Color3.fromRGB(69, 144, 200)
	-- ImageOpenClose.BackgroundTransparency = 1
	-- ImageOpenClose.Position = UDim2.new(0.08233337, 0, 0.0952890813, 0)
	-- ImageOpenClose.Size = UDim2.new(0.0447916649, 0, 0.0845824406, 0)
	-- ImageOpenClose.Image = "rbxassetid://9606070311"
	
	UICorner215.CornerRadius = UDim.new(0, 4)
	UICorner215.Parent = OpenClose

	StrokeOpenClose.Thickness = 1
	StrokeOpenClose.Name = ""
	StrokeOpenClose.Parent = OpenClose
	StrokeOpenClose.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
	StrokeOpenClose.LineJoinMode = Enum.LineJoinMode.Round
	StrokeOpenClose.Color = _G.Color
	StrokeOpenClose.Transparency = 0
	...
	spawn(function()
		while wait() do
			pcall(function()
				...
				TextLabeltime.Text = "Hours: "..os.date("%H")..":"..os.date("%M")..":"..os.date("%S")
	...
	Yedhee.TextTransparency = 1
        ...
        OpenClose.Parent = RippleOpenClose
        OpenClose.BackgroundColor3 = Color3.fromRGB(68, 202, 186)
        ...
        OpenClose.Text = ""
        OpenClose.TextColor3 = Color3.fromRGB(68, 202, 186) --68, 202, 186
		...
		MakeDraggable(Frametime,Frametime)
		MakeDraggable(Framefps,Framefps)
...
--game.StarterGui:SetCore("SendNotification", {
	--Title = "Solar Notification", 
	--Text = " "..game:GetService("MarketplaceService"):GetProductInfo("2753915549" or "4442272183" or "7449423635").Name.." "..Player.Name.." | Solar Hub",
...
--game.StarterGui:SetCore("SendNotification", {
--	Title = "Solar Notification", 
--  Text = " Welcome "..Player.Name.." to Solar Hub",
--	Icon = "http://www.roblox.com/asset/?id=9610159123",
--	Duration = 8.5
--})
...
local Credits_Tab = win:Tab("Credits",[[9606070311]])
...
General_Tab:Toggle("Auto Farm","9606294253",_G.Setting_table.AutoFarm,function(vu)
	...
	--game.StarterGui:SetCore("SendNotification", {
		--Title = "Solar Notification", 
		--Text = "⚠️ Select your weapon every time you enter in the game, idk how to fix this.",
		--Icon = "http://www.roblox.com/asset/?id=9606070311",
		--Duration = 30
	--})
--Text("Select your weapon every time you enter in the game, idk how to fix this")
	--end
end)
					...
					elseif game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true then
						if _G.Farm_Boss then
								...
								for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
									if v.Name == _G.SelectBoss and v.Humanoid.Health > 0 then
										...
										repeat wait(_G.Fast_Delay)
											...
											TP(v.HumanoidRootPart.CFrame*CFrame.new(1,30,50))
											AttackNoCD()
								...
								for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
									if v.Name == Ms and v.Humanoid.Health > 0 then
										...
										repeat wait(_G.Fast_Delay)
											...
											TelePBoss(CFrameQ)
											EquipWeapon(_G.Setting_table.Weapon)
											TP(v.HumanoidRootPart.CFrame*CFrame.new(5,30,10))
											AttackNoCD()
							...
							elseif game.ReplicatedStorage:FindFirstChild(Ms) then
								TP(game.ReplicatedStorage:FindFirstChild(Ms).HumanoidRootPart.CFrame*CFrame.new(5,30,10))
								game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")
								TelePBoss(CFrameQ)
							end
						end
...
General_Tab:Toggle("Auto Grab Chest Stop Fist of Dark","9606294253",_G.Setting_table.STP,function(vu)
	Grab_Chest = vu
	T_P_H = vu
...
General_Tab:Slider("Points",1,100,3,_G.Setting_table.Points,function(vu)
	_G.Setting_table.Gun_A = vu
	Update_Setting(getgenv()['MyName'])
	Points = vu
end)
				...
				if Lv >= 900 then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 0 then
						if string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Swan Pirates") and string.find(game.Players.LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "50") and game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == true then
							TP2(CFrame.new(927.8462524414062, 141.72720336914062, 1246.8447265625))
							if game.workspace.Enemies:FindFirstChild("Swan Pirate [Lv. 775]") then
								for i,v in pairs(game.workspace.Enemies:GetChildren()) do
									if v.Name == "Swan Pirate [Lv. 775]" then
										--927.8462524414062, 141.72720336914062, 1246.8447265625
										_G.PosMon = v.HumanoidRootPart.CFrame
										StatrMagnet = true
										repeat wait()
											for i2,v2 in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
...
Quest_Tab:Toggle("Auto Farm Factory", "9610159123", false,function(vu)
	Auto_Farm_Factory = vu
end)

spawn(function()
	while wait() do
		pcall(function()
			if Auto_Farm_Factory then
					...
					for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
						if v.Name == "Core" and v.Humanoid.Health > 0 then
                            repeat wait(_G.Fast_Delay)
								...
								game:GetService("VirtualUser"):CaptureController()
								game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
							until v.Humanoid.Health <= 0 or Auto_Farm_Factory == false
						end
					end
				else
					TP(CFrame.new(448.46756, 199.356781, -441.389252))
				...
				--			if v.Name == "rip_indra [Lv. 1500] [Boss]" then
					...
					--			repeat wait()
						...
						--			v.Humanoid.WalkSpeed = 0
							...
							--	until Auto_Three_World == false or v.Humanoid.Health <= 0 or not v.Parent
						--	end
						--end
...
Quest_Tab:Toggle("Auto Cake Prince","9610159123",_G.Setting_table.Auto_Cake_Prince,function(vu)
	Auto_Cake_Prince = vu
	_G.Setting_table.Auto_Cake_Prince = vu
	Update_Setting(getgenv()['MyName'])
end)
	...
	while wait(.5) do
		if Auto_Cake_Prince then
				if game.ReplicatedStorage:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince [Lv. 2300] [Raid Boss]") then   
						...
						for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do 
							if v.Name == "Cake Prince [Lv. 2300] [Raid Boss]" then
								...
								repeat wait(_G.Fast_Delay)
									...
									AttackNoCD()
								until v.Humanoid.Health <= 0 or not v.Parent or Mix_Farm or not Auto_Cake_Prince
							end    
						end    
					else
					...
					if game.Workspace.Enemies:FindFirstChild("Baking Staff [Lv. 2250]") or game.Workspace.Enemies:FindFirstChild("Head Baker [Lv. 2275]") or game.Workspace.Enemies:FindFirstChild("Cake Guard [Lv. 2225]") or game.Workspace.Enemies:FindFirstChild("Cookie Crafter [Lv. 2200]") or game.Workspace.Enemies:FindFirstChild("Baking Staff [Lv. 2250]") or game.Workspace.Enemies:FindFirstChild("Head Baker [Lv. 2275]") or game.Workspace.Enemies:FindFirstChild("Cake Guard [Lv. 2225]") or game.Workspace.Enemies:FindFirstChild("Cookie Crafter [Lv. 2200]") then
						game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetSpawnPoint")
						for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
							if v.Name == "Baking Staff [Lv. 2250]" or v.Name == "Head Baker [Lv. 2275]" or v.Name == "Cookie Crafter [Lv. 2200]" and v.Humanoid.Health > 0 then
								StatrMagnet = true
								repeat wait(_G.Fast_Delay)
									for i2,v2 in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
										if v2:IsA("Tool") then
						...
						StatrMagnet = false
						for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
							if v.Name == "Baking Staff [Lv. 2250]" then
								TP(v.HumanoidRootPart.CFrame * CFrame.new(1, 30, 0))
						...
						TP2(CFrame.new(-1564.482666015625, 37.8238639831543, -12307.140625))
						TP2(CFrame.new(-2222.39697265625, 53.42386245727539, -12763.1083984375))
						TP2(CFrame.new(-1860.2017822265625, 37.82398986816406, -12999.021484375))
						TP2(CFrame.new(-2290.214599609375, 69.94988250732422, -12040.73828125))
					end
				end
			end
		end
...
--spawn(function()
	...
	--	pcall(function()
		...
		--				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SickScientist","Check") ~= false then
					--		if not UHuHI then
			--		--		Text("I am farming the devil fruit mastery.")
							--	UHuHI = true
						--	end
				--			Auto_Farm_Fruit = true
						...
						----	if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SickScientist","Heal") == 1 then
							...
							--		_G.Phoenix_XR = true
								...
								--	if _G.Have_Fruit then
									...
									--		Text("Going down to push Phoenix to wake up.")
										--	repeat wait(1)
									...
									--	elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc", "Select", "Bird: Phoenix") == '[You already have a Special Microchip.]' then
										...
										--elseif _G.Setting_table.Phoenix_Hop then
										--	if not UHIkx then
										--		Text("Wait 2 hours until you can buy chips to push.\nPurple money is better to wait.")
										--		UHIkx = true
										--	end
										--	_G.Phoenix_R = true
										--	Raid_FG()
									--	else
										--	if not UHIkz then
										--		Text("Wait 2 hours until you can buy the chip to push.")
										--	UHIkz = true
										--	end
										--end
								...
								--			until game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == false
									...
									--	Mix_Farm = nil
									--else
									--	Text("Reach the money 1 million\nto buy chips for Phoenix")
									--	wait(10)
									--end
								--elseif Auto_Phoenix_Awaken_Ex then
								----	Auto_Phoenix_Awaken_Ex = nil
							...
							--	else
									--_G.Phoenix_R = true
								--	Raid_FG()
								--	Text("Purple money does not reach 6000\nCan't push")
								--	Text("Looking for results to push!")
								--	wait(10)
							--	end
						--	elseif FG < 1500 then
							--	if not LPOJO then
							--		Text("Purple money does not reach 1500\nThe quest cannot be completed.")
							--		Text("Looking for results to push!")
							--		LPOJO = true
							--	end
							--	_G.Phoenix_R = true
				...
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1") ~= -2 then
						...
						elseif not game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 3") and not game.Players.LocalPlayer.Character:FindFirstChild("Flower 3") then
							if PO == nil then
								Text("Looking for yellow flowers")
								PO = true
							end
					...
					Text("Dofla's door hasn't opened, can't make a race.")
					wait(5)
				end
				...
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1") ~= -2 then
						...
						elseif game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 3") and game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 1") and game.Players.LocalPlayer.Backpack:FindFirstChild("Flower 2") then
							...
							if not UHuits then
								Text("Waiting for the flowers to be born.")
								TP2(CFrame.new(-379.70889282227, 73.0458984375, 304.84692382813))
								UHuits = true
							end
							wait(2)
					...
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") ~= -2 then
						...
						elseif game.ReplicatedStorage:FindFirstChild("Diamond [Lv. 750] [Boss]") then
							...
							Text("Waiting for Boss born 5 - 15 minutes.")
							wait(10)
						end
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") == -2 then
						if not IUHidmr then
							Text("Finished the V3 Race!")
							IUHidmr = true
						end
						if _G.Setting_table.Next_Race then
							_G.Setting_table.Human_Evo_H = true
				...
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
					...
					elseif _G.Setting_table.Skypiea_Evo_V2 ~= true then
						if not UIjfizez then
							Text("I'm working on the SkyPiea V2")
							UIjfizez = true
						end
						if game.Workspace.Enemies:FindFirstChild("Don Swan [Lv. 1000] [Boss]") then
							repeat wait(_G.Fast_Delay)
						...
						elseif game.ReplicatedStorage:FindFirstChild("Don Swan [Lv. 1000] [Boss]") then
							...
							Text("Around Dofla was born.")
							TP(CFrame.new(2288.802, 15.1870775, 863.034607, 0.99974072, -8.41247214e-08, -0.0227668174, 8.4774733e-08, 1, 2.75850098e-08, 0.0227668174, -2.95079072e-08, 0.99974072))
							wait(10)
						end
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") ~= -2 then
						if not UIjfiez then
							Text("I'm working on the SkyPiea V3")
							UIjfiez = true
						end
						if not ijoijofdga then
							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1")
						...
						elseif _G.Setting_table.Race_Hop then
							Text("There is no one with Skypia in this world.")
							HopServer()
							wait(50)
						else
							Text("There is no person who has a Skypia in this world.")
							wait(7)
						end
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") == -2 then
						if not IUHidmrz then
							Text("Finished the SkyPiea V3!")
							IUHidmrz = true
						end
						if _G.Setting_table.Next_Race then
							_G.Setting_table.Skypiea_Evo_H = true
				...
				if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1") ~= -2 then
						if not UIhjdkhzt then
							Text("Working on the FishMan V1")
							UIhjdkhzt = true
						end
						pcall(function()
							game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist","1")
					...
					elseif _G.Setting_table.Fishman_Evo_V2 ~= true then
						if not UIjfizezt then
							Text("I'm working on the FishMan V2.")
							UIjfizezt = true
						end
						if game.Workspace.Enemies:FindFirstChild("Don Swan [Lv. 1000] [Boss]") then
							repeat wait(_G.Fast_Delay)
					...
					elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Wenlocktoad","1") ~= -2 then
						if not UIjfiezt then
							Text("I'm working on the FishMan V3.")
							UIjfiezt = true
						end
						...
						Text("The Sea Beast is not yet born.")
...
Quest_Tab:Toggle("Auto KoKo","9606294253",false,function(vu)
	if vu then
		Text("Not done yet")
	end
end)
...
local I_A = game:GetService("ReplicatedStorage").Remotes["CommF_"]:InvokeServer("getInventoryFightingStyle")
            ...
            if Triple_A then
                ...
                elseif _G.Setting_table.Triple_Hop then
					...
					if Beli < 2000000 then
						Text("Waiting for the TTK seller to be born.")
						Auto_Farm_Sword = true
						wait(10)
					else
...
Mics_Tab:Toggle("Auto Teleport To Position Spawn","9606294253",_G.Setting_table.TP_Position_Spawn,function(vu)
...
Mics_Tab:Button("Set Position Spawn",function()
	_G.Setting_table.Pos_Spawn = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
	Update_Setting(getgenv()['MyName'])
	Com()
end)

Mics_Tab:Button("Unlock Portals",_G.Setting_table.Unlock_Portals,function(vu)
	_G.Setting_table.Unlock_Portals = vu
	Unlock_Portals = vu
end)
...
Mics_Tab:Seperator("Setting Haki State")
HakiS = {
	"State 0",
	"State 1",
	"State 2",
...
Mics_Tab:Dropdown("Select Haki State",_G.Setting_table.SelectStateHaki,HakiS,function(vu)
	SelectStateHaki= vu
	_G.Setting_table.SelectStateHaki = vu
end)

Mics_Tab:Button("Change Buso Haki State",function()
...
Mics_Tab:Seperator("Abilities")

Mics_Tab:Toggle("Flash Speed","9606294253",false,function(value)
	InfAbility = value
	if value == false then
		game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
	end
...
Mics_Tab:Toggle("Infinite Obversation Range","9606294253",getgenv().InfiniteObRange,function(value)
...
Mics_Tab:Toggle("Infinite Soru","9606294253",getgenv().InfSoru,function(value)
...
--Mics_Tab:Label("No Cooldown & Infinity")
--Mics_Tab:Toggle("Soru No Cooldown","9606294253",_G.Setting_table.Sorunocool,function(vu)
--	Sorunocool = vu
...
--function NoSoruCool()
   ...
   -- end
--end
--Mics_Tab:Toggle("Dodge No Cooldown","9606294253",_G.Setting_table.Dodge_No_Cooldown,function(vu)
--	nododgecool = vu
...
--end)
	...
	--	end
	--end
	--Mics_Tab:Toggle("Infinity Geppo","9606294253",_G.Setting_table.Infinity_Geppo,function(vu)
	--noGeppocool = vu
...
--end
--end)
--Mics_Tab:Toggle("Infinity Energy","9606294253",_G.Setting_table.InfinitsEnergy,function(vu)
--	InfinitsEnergy = vu
--	infinitestam()
				...
				if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == false then
					if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Special Microchip") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Special Microchip") then
						...
						elseif Auto_Raid_Farm and not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Special Microchip") and not game:GetService("Players").LocalPlayer.Character:FindFirstChild("Special Microchip") then
							...
							_G.Stop_Tween = nil
							Auto_Raid_Farm = nil
							Text("There are no devil fruits left.")
						end
					end
				elseif game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
					repeat wait(1)
...
Island_Tab:Button("Rejoin Server",function()
	game.StarterGui:SetCore("SendNotification", {
        Title = "Rejoin Server", 
        Text = "Ready Go!",
        Icon = "http://www.roblox.com/asset/?id=9606070311",
...
elseif Three_World  then --game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))

	Island_Tab:Button("Mirage Island [Only if its spawned!]", "9606294253",function()
			if game:GetService("Workspace").Map:FindFirstChild("MirageIsland") then
			TP2(game:GetService("Workspace").Map:FindFirstChild("MirageIsland").HumanoidRootPart.CFrame * CFrame.new(0,500,-100))
		end
	end)
    ...
    Island_Tab:Button("Great Tree Island", function()
        TP2(CFrame.new(2276.0859375, 25.87850189209, -6493.03125))
    end)
    
    Island_Tab:Button("Floating Turtle Island", function()
    ...
    Island_Tab:Button("Ice Cream Island",function()
        TP2(CFrame.new(-841.38330078125, 65.81950378417969, -10938.7998046875))
    end)
    Island_Tab:Button("Sea of Cake",function()
    ...
    Island_Tab:Button("Chocolate Island",function()
        TP2(CFrame.new(67.42575073242188, 24.7342529296875, -12059.064453125))
    end)
end

if Three_World  then --game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))

	Island_Tab:Label("Portals [You need to kill rip indra to unlock this]")

	Island_Tab:Button("Mansion", function()
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-5094.5244140625, 316.50665283203125, -3144.339599609375))
    end)

    Island_Tab:Button("Castle on the Sea", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-12463.126953125, 376.3315734863281, -7564.8701171875))
    end)
	...
	Island_Tab:Button("Hydra Island", function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-5103.8173828125, 316.5050964355469, -3169.454345703125))
    end)
end
...
Status_Tab:Label("Status Fighting Styles")
local ST_Superhuman = Status_Tab:LabelP("❌: Superhuman")
local ST_Death_Step = Status_Tab:LabelP("❌: Death Step")
local ST_Sharkman_Karate = Status_Tab:LabelP("❌: Sharkman Karate")
local ST_Eletric_Claw = Status_Tab:LabelP("❌: Eletric Claw")
local ST_Dragon_Talon = Status_Tab:LabelP("❌: Dragon Talon")
local ST_Godhuman = Status_Tab:LabelP("❌: Godhuman")
...
local ST_Tushita = Status_Tab:LabelP("❌: Tushita")
local ST_Yama = Status_Tab:LabelP("❌: Yama")
local ST_Spikey_Trident = Status_Tab:LabelP("❌: Spikey Trident")
local ST_Buddy_Sword = Status_Tab:LabelP("❌: Buddy Sword")
local ST_Canvander = Status_Tab:LabelP("❌: Canvander")
local ST_KoKo = Status_Tab:LabelP("❌: KoKo")
local ST_Hallow_Scythe = Status_Tab:LabelP("❌: Hallow Scythe")
local ST_Dark_Dagger = Status_Tab:LabelP("❌: Dark Dagger")
local ST_Cursed_Dual_Katana = Status_Tab:LabelP("❌: Cursed Dual Katana")
local ST_True_Triple_Katana = Status_Tab:LabelP("❌: True Triple Katana")
function CheckStatus()
	...
	if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TalkTrevor","1") == 0 then
		Open_Don_Swan_ST:Set("✅ : Open Donfla Room Quest")
	end
	...
	for i,x in pairs(I_W) do
		...
		if v.Name == "Tushita" then
			ST_Tushita:Set("✅ : Tushita")
		end
		if v.Name == "Yama" then
			ST_Yama:Set("✅ : Yama")
		end
		if v.Name == "Spikey Trident" then
			ST_Spikey_Trident:Set("✅ : Spikey Trident")
		end
		if v.Name == "Buddy Sword" then
			ST_Buddy_Sword:Set("✅ : Buddy Sword")
		end
		if v.Name == "Canvander" then
			ST_Canvander:Set("✅ : Canvander")
		end
		if v.Name == "Koko" then
			ST_KoKo:Set("✅ : KoKo")
		end
		if v.Name == "Hallow Scythe" then
			ST_Hallow_Scythe:Set("✅ : Hallow Scythe")
		end
		if v.Name == "Dark Dagger" then
			ST_Dark_Dagger:Set("✅ : Dark Dagger")
		end
		if v.Name == "Cursed Dual Katana" then
			ST_Cursed_Dual_Katana:Set("✅ : Cursed Dual Katana") 
		end
		if v.Name == "True Triple Katana" then
			ST_True_Triple_Katana:Set("✅ : True Triple Katana")
		end
	end
...
Status_Tab:Seperator("Status Server")

Time = Status_Tab:LabelP("Server Time: ")
...
function UpdateTime()
    ...
    Time:Set(" 🌐 Server Time: Hours: "..Hour.." Minutes: "..Minute.." Seconds: "..Second)
end
...
ping = Status_Tab:LabelP("Server Ping: ")

function UpdateClient()
    local Ping = game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString()
    ping:Set(" 🌐 Server Ping: "..Ping.." ")
end
...
Status_Tab:Seperator("Check Status")
Status_Tab:Button("Show All Items",function()
...
Esp_Tab:Toggle("ESP Islands","9606294253",false,function(a)
	IslandESP = a
	UpdateIslandESP() 
end)
...
Setting_Tab:Label("Setting Player")

Setting_Tab:Button("Join Pirate Team", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates")
end)

Setting_Tab:Button("Join Marine Team", function()
...
Setting_Tab:Button("Redeem All Code",function()
	...
	UseCode("FUDD10")
	Text("All codes have been updated: 31/10/2022!")
end)
...
Hop_Tab:Label("Main")
Hop_Tab:Toggle("Bring Fruit Hop [Dropped only]","9606294253",_G.Setting_table.BringFruit_Hop,function(vu)
	BringFruit = vu
...
Credits_Tab:Seperator("Owner")

Credits_Tab:Button("Made by yPolar#7294",function()
	setclipboard("yPolar#7294")
	Text("Copied discord username\n Any errors or bugs contact me on discord!")
end)

Credits_Tab:Seperator("Update Log")

Credits_Tab:Button("View Update Log",function()
	setclipboard("https://pst.klgrth.io/paste/on6tr/raw")
	Text("Copied link to update log!")
end)
...
local executorname = identifyexecutor()
    game.StarterGui:SetCore("SendNotification", {
            Title = ""..executorname.." Executor",
            Text = "Logged in "..Player.Name.."!",
			Icon = "http://www.roblox.com/asset/?id=9606070311",
            Duration = 15
        })
